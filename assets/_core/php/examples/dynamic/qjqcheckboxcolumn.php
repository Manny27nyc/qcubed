<?php
	...
	class ExampleForm extends QForm {
		...
		protected function dtgProjects_Create() {
			...
			$this->colProjectSelected = new QJqCheckBoxColumn(QApplication::Translate('Select'), $this->dtgProjects);
		...
		public function colProjectSelectedCheckbox_Created(Project $_ITEM, QJqCheckBox $ctl)
		{
