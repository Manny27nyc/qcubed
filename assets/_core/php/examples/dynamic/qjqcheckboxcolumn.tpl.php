...
<div id="instructions">
	<h1>Using the QJqCheckBoxColumn</h1>
	...
	using a simpler method. This time around we're using the <strong>QJqCheckBoxColumn</strong>, and letting 
	...
	we just create the QJqCheckBoxColumn, and we can use the column's <strong>GetSelectedItems()</strong> function 
	...
	on a QJqCheckBoxColumn because it is impossible to add an action to the Select All checkbox.</p>
	...
	<p>First, we once again create the <strong>QJqCheckBoxColumn</strong>, and again we call
	...
	nice that the QJqCheckBoxColumn takes care of figuring out which items have been <strong>deselected</strong>
	for us as well.</p>
	...
	<p>Finally, you should note that using a QJqCheckBoxColumn requires that the databound object's
